...
def read_pypower_metrics (dir, nameroot):
  # first, read and print a dictionary of relevant PYPOWER objects
  lp = open (dir + nameroot + '_m_dict.json').read()
  dict = json.loads(lp)
  ...
  lp_b = open (dir + 'bus_' + nameroot + '_metrics.json').read()
  ...
  lp_g = open (dir +'gen_' + nameroot + '_metrics.json').read()
