...
def read_gld_metrics (dir, nameroot, dictname = ''):
  ...
  if len (dictname) > 0:
      ...
      lp = open (dir + nameroot + '_glm_dict.json').read()
  dict = json.loads(lp)
  ...
  lp_s = open (dir + 'substation_' + nameroot + '_metrics.json').read()
...
#    print (key, val['index'], val['units'])
  ...
  lp_m = open (dir + 'billing_meter_' + nameroot + '_metrics.json').read()
  lst_m = json.loads(lp_m)
  lp_i = open (dir + 'inverter_' + nameroot + '_metrics.json').read()
...
#    print (key, val['index'], val['units'])
  ...
  lp_c = open (dir + 'capacitor_' + nameroot + '_metrics.json').read()
  lst_c = json.loads(lp_c)
  lp_r = open (dir + 'regulator_' + nameroot + '_metrics.json').read()
