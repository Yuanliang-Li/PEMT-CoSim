...
class GLM_HELPER:
    ...
    def configure_PV(self, house_par_dict, vpp_idx, phase, house_idx):
        ...
        num_pv_panels = max(2, int(random.randint(2,16)* self.ratio_PV_generation_list[vpp_idx]))
    ...
    def configure_battery(self, house_par_dict, vpp_idx, phase, house_idx):
        ...
        battery_capacity = 10 # 10 kW
        random.seed(seed)
        state_of_charge = round(random.uniform(0.6,1),2)
